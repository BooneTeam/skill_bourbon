...
skill_levels   = [{level_num: 1, title:"No Experience",description:"No Experience"},
                  ...
                  {level_num: 5, title:"Advanced" ,description:"You are a master in this field. You will always have more to learn but you are truly skilled in this Skillset."}]
...
# Apprenticeship.create!(user_id: User.last.id, skill_id: 2,
  # apprentice_level: rand(10),meeting_date_scheduled: DateTime.now + 5.days,
  # meeting_date_requested: DateTime.now - 2.days , location_id: Location.first.id,
...
# Apprenticeship.create!(user_id: User.last.id, skill_id: 1,
  # apprentice_level: rand(10), meeting_date_scheduled: DateTime.now + 1.days,
  # meeting_date_requested: DateTime.now - 2.days , location_id: Location.find(2).id,
...
# Apprenticeship.create!(user_id: User.first.id,  skill_id: 3,
  # apprentice_level: rand(10),meeting_date_scheduled: DateTime.now + 5.days,
  # meeting_date_requested: DateTime.now - 3.days , location_id: Location.first.id,
...
# Apprenticeship.create!(user_id: User.first.id,  skill_id: 2,
  # apprentice_level: rand(10),meeting_date_scheduled: DateTime.now + 6.days,
  # meeting_date_requested: DateTime.now - 5.days , location_id: Location.first.id,
...
# Apprenticeship.create!(user_id: User.find(2).id,  skill_id: 3,
  # apprentice_level: rand(10),meeting_date_scheduled: DateTime.now + 5.days,
  # meeting_date_requested: DateTime.now - 1.days , location_id: Location.find(2).id,
