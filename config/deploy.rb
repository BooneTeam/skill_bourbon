...
set :domain, '104.131.189.240'
set :deploy_to, '/var/www/skillclimb'
set :repository, 'git@github.com:BooneTeam/skill_bourbon.git'
set :branch, 'master'
...
task :environment do
  ...
  # invoke :'rbenv:load'
  invoke :'rvm:use[ruby-2.1.1@skillclimb]'
